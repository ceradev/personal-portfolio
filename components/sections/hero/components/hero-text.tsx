...
export function HeroText() {
  return (
    <>
      ...
      <motion.h2 
        className="text-sm sm:text-lg md:text-lg lg:text-xl xl:text-2xl text-foreground/90 dark:text-foreground/95 mb-3 sm:mb-4 md:mb-6 font-light drop-shadow-sm px-2 sm:px-4 md:px-6"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
