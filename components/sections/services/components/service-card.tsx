...
export function ServiceCard({ service, index }: ServiceCardProps) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="group relative overflow-hidden border-2 border-red-300/40 bg-gradient-to-br from-background/90 to-red-50/20 backdrop-blur-sm p-6 transition-all duration-300 hover:border-red-400/60 hover:shadow-2xl hover:shadow-red-200/30 h-full">
