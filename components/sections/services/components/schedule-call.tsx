        ...
        >
          ...
          >
            <motion.div
              ...
              className="p-4 rounded-2xl bg-gradient-to-br from-red-500/30 to-red-500/20 shadow-md shadow-red-500/20"
            >
            ...
            <motion.div
              ...
              className="p-3 rounded-full bg-gradient-to-br from-red-500/40 to-red-500/30"
            >
            ...
            >
              <div className="relative p-6 rounded-xl bg-background border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 text-center">
                <motion.div
                  ...
                  className="inline-flex p-3 rounded-xl bg-gradient-to-br from-blue-500/30 to-blue-500/20 shadow-md shadow-blue-500/20 mb-3"
                >
            ...
            >
              <div className="relative p-6 rounded-xl bg-background border border-green-500/20 hover:border-green-500/40 transition-all duration-300 text-center">
                <motion.div
                  whileHover={{ scale: 1.1, rotate: -5 }}
                  transition={{ duration: 0.3 }}
                  className="inline-flex p-3 rounded-xl bg-gradient-to-br from-green-500/30 to-green-500/20 shadow-md shadow-green-500/20 mb-3"
                >
            ...
            >
              <div className="relative p-6 rounded-xl bg-background border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 text-center">
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  transition={{ duration: 0.3 }}
                  className="inline-flex p-3 rounded-xl bg-gradient-to-br from-purple-500/30 to-purple-500/20 shadow-md shadow-purple-500/20 mb-3"
                >
