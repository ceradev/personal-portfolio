...
const COMPACT_SKILLS: TechSkill[] = [
  ...
  { name: "Angular", icon: <SiAngular className="h-5 w-5 text-red-500" />, category: 'frontend' },
  ...
  { name: "Spring Boot", icon: <SiSpring className="h-5 w-5 text-green-600" />, category: 'backend' },
  ...
  { name: "Jest", icon: <SiJest className="h-5 w-5 text-red-500" />, category: 'tools' },
  { name: "Webpack", icon: <SiWebpack className="h-5 w-5 text-blue-400" />, category: 'tools' },
