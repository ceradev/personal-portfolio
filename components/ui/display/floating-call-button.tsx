...
export function FloatingCallButton({ className = "", activeSection = "home" }: FloatingCallButtonProps) {
  ...
  return (
    <div className={`fixed z-50 ${isMobile ? "bottom-20 right-4" : "bottom-6 right-6"} ${className}`}>
      <AnimatePresence>
        {isExpanded ? (
          <motion.div
          ...
          >
            ...
            >
              <Button
                ...
                size="icon"
                className="w-12 h-12 rounded-full bg-red-500 hover:bg-red-600 text-white shadow-lg hover:shadow-xl transition-all duration-300"
              >
                <X className="h-5 w-5" />
              </Button>
            </motion.div>
          ...
          >
            <Button
              ...
              size="icon"
              className="w-14 h-14 rounded-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-glow"
            >
